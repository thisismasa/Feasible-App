...
-- 2. Fix wrong column names (sessions_remaining → remaining_sessions, etc.)
-- ============================================================================
...
-- ============================================================================
-- Fixes:
-- ✅ Uses remaining_sessions (not sessions_remaining)
-- ✅ Uses is_active (not status = 'active')
-- ✅ Decrements remaining_sessions, increments used_sessions
-- ✅ Allows same-day booking (0 hours advance)
-- ============================================================================
...
BEGIN
  ...
  -- ✅ FIXED: Column is remaining_sessions (not sessions_remaining)
  -- ✅ FIXED: Column is is_active (not status)
  ...
  -- ✅ FIXED: Correct column names (remaining_sessions/used_sessions not sessions_scheduled)
...
'✅ FIXED: Column names + allow same-day booking (0 hours)';

-- ============================================================================
-- STEP 4: Create get_available_slots - CORRECT VERSION
-- ============================================================================
-- Fixes:
-- ✅ Changed <= to < (allow booking at current time)
...
'✅ FIXED: Allow current time + correct working hours';
...
SELECT '' as blank;
SELECT '✅ Fixed column names:' as fix_1;
SELECT '   • sessions_remaining → remaining_sessions' as fix_1a;
SELECT '   • status → is_active' as fix_1b;
SELECT '   • sessions_scheduled → remaining_sessions/used_sessions' as fix_1c;
SELECT '' as blank2;
SELECT '✅ Fixed booking restrictions:' as fix_2;
SELECT '   • 2 hours advance → 0 hours (allow today)' as fix_2a;
SELECT '   • Time check: <= → < (allow current time)' as fix_2b;
SELECT '' as blank3;
