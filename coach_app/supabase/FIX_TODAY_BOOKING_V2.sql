-- ============================================================================
-- FIX: Allow booking TODAY (October 28th) - Fixed version with DROP
-- ============================================================================
-- ERROR FIX: Drop existing functions first to avoid "function name not unique"
-- PROBLEM 1: book_session_with_validation requires 2 hours advance
-- PROBLEM 2: get_available_slots uses <= which blocks current time slots
-- ============================================================================

-- ============================================================================
-- STEP 1: Drop existing functions (all overloads)
-- ============================================================================

DROP FUNCTION IF EXISTS book_session_with_validation(
  UUID, UUID, TIMESTAMPTZ, INTEGER, UUID, TEXT, TEXT, TEXT
) CASCADE;
...
-- ============================================================================
-- STEP 2: Create book_session_with_validation - Remove 2-hour advance requirement
-- ============================================================================
...
-- ============================================================================
-- STEP 3: Create get_available_slots - Allow slots at current time
-- ============================================================================
